...
class BaseLogger:
    """Base class to set up a logger with a default `StreamHandler` using
    stderr with the same JSON formatter as pycti's loggers.
    """
    ...
    @classmethod
    def wrap_python_logger(cls, existing_logger: logging.Logger) -> "BaseLogger":
        """Build a `BaseLogger` wrapper around a python `logging.Logger` instance."""
    ...
    def get_child(self, name: str) -> "BaseLogger":
        ...
        return BaseLogger.wrap_python_logger(child_logger)
